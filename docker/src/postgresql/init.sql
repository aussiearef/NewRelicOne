...
-- Replace the raw CREATE USER line with this safe block:
DO $$
BEGIN
    IF NOT EXISTS (SELECT FROM pg_catalog.pg_roles WHERE rolname = 'astronomy_user') THEN
        CREATE USER astronomy_user WITH PASSWORD 'astronomy_pass';
    END IF;
END
$$;
